...
locals {
  ...
  get_course_log_group_name      = "/aws/lambda/get-course-dev-lambda"
  save_course_log_group_name     = "/aws/lambda/save-course-dev-lambda"
  update_course_log_group_name   = "/aws/lambda/update-course-dev-lambda"
  delete_course_log_group_name   = "/aws/lambda/delete-course-dev-lambda"
}
